  ...
  function renderAI() {
    ...
    if (!checks.length) {
      ...
      var actA = chg.length
        ...
        : (prevD ? (aiGapLine((typeof todayRows!=='undefined'?todayRows:null),(typeof rowsAll!=='undefined'?rowsAll:null),prevD,(typeof escAI!=='undefined'?escAI:null)) || ('Nothing changed since ' + escAI(prevD) + '. No action needed today.')) : 'This is your first check, so there is nothing to compare yet. We start tracking changes from tomorrow.');
